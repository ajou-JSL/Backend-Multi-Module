...
public class LikesDto {
    ...
    public static class Response{
        ...
        public Response(LikesEntity likesEntity) {
            ...
            this.articleId = (likesEntity.getArticle().getId() != null) ? likesEntity.getArticle().getId() : null;
            this.performArticleId = (likesEntity.getPerformArticle().getId() != null) ? likesEntity.getPerformArticle().getId() : null;
        }
    }
}
