    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers("/public/files/performanceHall/**").permitAll()
                        .requestMatchers("/public/files/practiceRoom/**").permitAll()
                        .requestMatchers("/public/files/profiles/**").permitAll()
                        .requestMatchers("/public/files/chatrooms/**").permitAll()
                        .requestMatchers("/public/files/articles/**").permitAll()
                        .requestMatchers("/public/files/performs/**").permitAll()
                        .requestMatchers("/public/files/moums/**").permitAll()
                        .requestMatchers("/public/files/teams/**").permitAll()
